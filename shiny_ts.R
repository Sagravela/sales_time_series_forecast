...
fc_train <- read_parquet("forecast/fc_train.parquet") |> mutate(.model = toupper(.model))
fc_arima <- read_parquet("forecast/fc_arima.parquet") |> mutate(.model = toupper(.model))
fc_stl <- read_parquet("forecast/fc_stl.parquet") |> mutate(.model = toupper(.model))
# Residuals
res <- read_parquet("model/residuals.parquet") |> mutate(.model = toupper(.model))
